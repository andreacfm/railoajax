...
<ul>
	...
	<li>
		...
		must reproduce the original demo css folder structure. More on docs about this.
	</li>
...
<p>This page code</p>
<pre>
 &lt;cfajaximport csssrc="/demo/cfajaximport/css/"/>
 &lt;cfwindow name="win1" source="#getContextRoot()#/demo/cfajaximport/files/changecss.cfm" 
      initShow="true"/>	  
</pre>
