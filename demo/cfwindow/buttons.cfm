...
<pre>
&lt;button 
onclick="Railo.Window.create('win9','win9','/demo/cfwindow/files/fly.cfm',
		{initShow:true,
...
<input type="button" class="submitButton" onclick="Railo.Window.create('win9','win9','<cfoutput>#getContextRoot()#</cfoutput>/demo/cfwindow/files/fly.cfm',{initShow:true,buttons:{ok:function(ui){alert('Button ' + $(ui.target).text());},close:function(){$(this).dialog('close');}}});" value="Create Win 9"/>
